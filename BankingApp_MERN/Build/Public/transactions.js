...
function Transactions() {
  ...
  var filteredTransactions = selectedUser ? transactionsdata.filter(function (transaction) {
    return transaction.email === selectedUser && (transaction.typeTrans == 'Deposit' || transaction.typeTrans == 'Withdraw');
  }) : transactionsdata.filter(function (transaction) {
    return transaction.typeTrans == 'Deposit' || transaction.typeTrans == 'Withdraw';
  });
